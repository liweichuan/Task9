...
//    public RMIService rmiService;
    ...
    public String toUpdateStudent(Model model,@PathVariable Long student_id){
        model.addAttribute("student",this.studentService.findStudentById(student_id));
        return "editStudent";
    }
    /**
     * 更新学生数据
    ...
    public String updateStudent(Model model,HttpServletRequest request,
        ...
        if (this.studentService.updateStudentById(student)){
            student=this.studentService.findStudentByName(student.getName());
            logger.error(student);
            model.addAttribute("student",student);
            return "redirect:/student/list";
        }else {
    ...
    public String deleteStudent( @PathVariable String name,Model model)throws Exception{
        if (this.studentService.deleteStudentByName(name)){
    ...
    public String findStudent(Model model, HttpServletRequest request, String name,
        ...
        List<Student> students= Collections.singletonList(this.studentService.findStudentByName(name));
